export function VerifyErroCode(errorCode: string): string {
  const errorMessages: Record<string, string> = {
    ...
    "auth/operation-not-allowed":
      "O tipo de conta correspondente a esta credencial ainda não está ativado.",
    ...
    "auth/operation-not-supported-in-this-environment":
      "Esta operação não é suportada no ambiente em que está sendo executada. Verifique se deve ser HTTP ou HTTPS.",
    "auth/timeout":
